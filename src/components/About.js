    ...
    <div className="about">
      ...
      <div className="about-me">
        <p>
         ...
         <p>
          I love birds and watching them do cute, amusing, and inexplicable bird things. A birdfeeder that I set up on my porch before the lockdown started has provided hours of entertainment. Saturdays are Peanut Day, when I get to see my mischevious scrub jay stuff 4 peanuts into its beak before it flies away. My most intense birdwatching experience was when I went on an 8-hour boat ride to the Farrallon Islands. I stood the whole time so I didn’t get seasick and was rewarded by spotting a black-footed albatross! 
        </p>
      </div>
    </div>
  )
