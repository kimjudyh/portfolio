  ...
  return (
    <div className="about " id="about-link">
      ...
      <div className="about-picture-container">
        ...
        <div className="about-picture-frame">
          <img src={process.env.PUBLIC_URL + '/images/blackcomb_glacier.jpg'} alt="me at blackcomb glacier" title="Enjoying the view after an uncomfortable T-bar lift"/>
        </div>
        <div className="about-picture-frame">
          <img src={process.env.PUBLIC_URL + '/images/farallon.jpg'} alt="me on a boat to the farallon islands" title="All smiles despite choppy waves and cold seaspray"/>
        </div>
